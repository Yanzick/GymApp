...
public class AddLich2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegisterSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                maNV = intent.getStringExtra("tenKH");
                ...
                for (int i = 0; i < dayAdapter.getItemCount(); i++) {
                    ...
                    if (dayAdapter.isDaySelected(i)) {
                        ...
                        String documentPath = String.format("LichKH/%s/years/%s/months/%s/days/%02d", maNV, selectedYear, selectedMonth, day);
                        ...
                        db.document(documentPath).set(scheduleData)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        // Xử lý thành công
                                        Toast.makeText(AddLich2.this, "Đã thêm lịch tập vào Firestore", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        // Xử lý khi thất bại
                                        Toast.makeText(AddLich2.this, "Lỗi: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }
